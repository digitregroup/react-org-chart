      ...
      .attr(
        ...
        d => {
          if (d.children) {
            ...
            return 'transform', 'translate(3.5, 3.5) scale(-1, 1) translate(-3.5, -3.5) rotate(45, 3.5, 3.5)';
          } else {
            // Expand the children
            return 'transform', 'translate(3.5, 3.5) scale(-1, 1) translate(-3.5, -3.5) rotate(225, 3.5, 3.5)';
          }
        }
      )
